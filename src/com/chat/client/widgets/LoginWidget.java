    ...
    private void doCallback() {
        ChatService.App.getInstance().checkLogin(login.getText(), new AsyncCallback<Integer>() {
            ...
            public void onSuccess(Integer result) {
                switch (result){
                    case 1: attemptLogin(login.getText()); break;
                    case 2:Window.alert("Логин уже занят, используйте другой"); break;
                    case 3:Window.alert("Длина логина не менее 8 и не более 30 символов"); break;
                    default: Window.alert("Неизвестный код ошибки"); break;
                }
            }
        });
    }
